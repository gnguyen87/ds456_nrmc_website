...
@cr-map-svi-1  Neighborhood who are **less socially vulnerable** tend to reside in **higher HOLC** grade neighborhoods with **dense** concentrations of racial covenants.![](assets/images/holc_grade_legend.png){width="100"}![](assets/images/svi_legend.png){width="120"}
...
@cr-map-lst-1 In **higher HOLC** grade neighborhoods with **dense** concentrations of racial covenants, today's land surface temperature is **markedly lower**.![](assets/images/holc_grade_legend.png){width="93"}![](assets/images/mean_lst_legend.png){width="120"}
