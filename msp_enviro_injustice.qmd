...
[@cr-map-lst]{pan-to="220px, -300px" scale-by="1.6"} In **higher HOLC** grade neighborhoods with **dense** concentrations of racial covenants, today's land surface temperature is **markedly lower**.![](assets/images/holc_grade_legend.png){width="110"}![](assets/images/mean_lst_legend.png){width="120"}

[@cr-map-lst]{pan-to="50px, 300px" scale-by="1.6"} Contrastly, land surface temperature is **remarkably higher** in areas that were deemed as **"declining", "hazardous", and "undesirable"**--areas where there were little to no racial covenants.![](assets/images/holc_grade_legend.png){width="110"}![](assets/images/mean_lst_legend.png){width="120"}

::: {#cr-map-lst}
<div style="display: flex; justify-content: center; gap: 5.5px;">
![](assets/images/racial_cov.png){fig-align="center" width="40%"}
![](assets/images/mean_lst.png){fig-align="center" width="41.2%"}
</div>
:::
:::
